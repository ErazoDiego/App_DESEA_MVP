...
/// Fondo oscuro profundo — idéntico al de HomeScreen.
...
/// Shader two-tone para el logo DESEA (hot pink → blanco, stop 0.35).
              ...
              children: [
                ...
                _AnimatedItem(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: const Color(0xFFBF5FFF).withValues(alpha: 0.75),
                      fontSize: 15,
                ...
                const Spacer(flex: 3),
                // ── CTA "Comenzar" estilo premium (stagger 350ms) ──
                _AnimatedItem(
                  animation: _ctaAnim,
                  child: SizedBox(
